...
for(var i = 0; i < result.length; i++) {
    ...
    if(Object.keys(result[i]) == "Inverter1") {
        // console.log("testing", result[i])
        result.push({Inverter1: [{ Sungrow: [{ All: [{ V1_0: parsingVersion}]}]}]})
        // console.log("testing end", result)
            ...
            if(Object.keys(result2[i] == "Sungrow")) {
                ...
                for(var i = 0; i < result3.length; i++) {
                    if(Object.keys(result3[i] == "All")) {
                        ...
                        // result4 = {V1_0: one}
                        console.log("version1 : ", result3[i].All)
                    }
                    for (var i = 0; i < result4.length; i++) {
                        console.log("last : ", result4[i].V1_0)
                    }
                }
            }
        }

    ...
    const dashboard = await DashBoard.findOne({
        ...
        if(!dashboard) {
            ...
            // console.log(abc);
                ...
                var responseArray =[{Category: "Inverter1", Details: [{Make: "Sungrow12", Details: [{Model: "All1", Version: ["v1", "v2"]}]},
                {Make: "Sungrow123", Details: [{Model: "All1", Version: ["v1", "v2"]}]}
            ]},
                ...
                device.forEach (async catArray => {
                   ...
                   if(!catResponse1.status) {
                        ...
                        // let obj1 = {};
                        // obj1[key] = []
                        // console.log("aaaaaaaaaaa", obj1[key])
                        // let test = responseArray[0].Details[0]
                        ...
                        // testing = responseArray[0].Details
                        // console.log("testing : ", testing)
                        responseArray.push(obj)
                        console.log("response : ", responseArray[2])
                   ...
                   if(!catResponse2.status) {
                        ...
                        responseArray.push(obj)
                        // console.log("answer : ", responseArray)
                   }
                   //    if(!catResponse1.status)
                //    {
                //        console.log("+++++")
